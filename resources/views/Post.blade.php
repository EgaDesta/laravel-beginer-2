...
@section('container')
    ...
    <h1 class="mb- text-center">{{ $title }}</h1>
        ...
        <div class="container">
            <div class="row">
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 ">
                        <div class="card">
                            <div class=" position-absolute  p-3  px-3 py-2 "
                                style="background-color:rgba(49, 47, 47, 0.429)">
                            ...
                            <div class="card-body">
                                ...
                                <p>
                                    <small class="text-muted">
                                        By. <a
                                            href="/authors/{{ $post->author->username }}"class="text-decoration-none">{{ $post->author->name }}</a>{{ $post->created_at->diffForHumans() }}
                                    </small>
                                </p>
